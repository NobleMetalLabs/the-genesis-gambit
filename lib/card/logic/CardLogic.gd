...
func _set_game_access(_game_access : GameAccess) -> void:
	...
	game_access.event_scheduler._register_bulk([
		...
		EventProcessingStep.new(owner, "LEFT_HAND", owner, _handle_left_hand, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "ENTERED_FIELD", owner, _handle_entered_field, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "LEFT_FIELD", owner, _handle_left_field, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "WAS_BURNED", owner, _handle_was_burned, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		...
		EventProcessingStep.new(owner, "TARGETED", owner, _handle_targeted, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "WAS_TARGETED", owner, _handle_was_targeted, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "SUPPORTED", owner, _handle_supported, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "WAS_SUPPORTED", owner, _handle_was_supported, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "KILLED", owner, _handle_killed, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "WAS_KILLED", owner, _handle_was_killed, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "GAVE_MOOD", owner, _handle_gave_mood, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "GAINED_MOOD", owner, _handle_gained_mood, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
		EventProcessingStep.new(owner, "TOOK_MOOD", owner, _handle_took_mood, EventPriority.new().RARITY_FROM_CARD(owner).INDIVIDUAL(EventPriority.PROCESSING_INDIVIDUAL_MIN)),
